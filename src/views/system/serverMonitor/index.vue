  ...
  <PageWrapper title="系统监控">
    <template #headerContent>
      <div class="flex justify-between items-center">
        <span class="flex-1">
          <a href="https://github.com/huashao1123/dragon.core" target="_blank">Dragon.Core</a>
          基于.NET6实现的通用管理平台，前端采用Vue3/Vben框架。整合最新技术，模块插件式开发，前后端分离，开箱即用。让开发更简单、更通用、更流行！
        </span>
      </div>
    </template>
    <a-row>
...
<script lang="ts">
  ...
  import { serverBase, serverUse, serverNetWork } from '/@/api/system/server';
